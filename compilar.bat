...
SET CPATH=.\src
SET OPATH=.\obj
SET INC_LPC_PATH=C:\Users\PC~Testing3\Downloads\Tp_digitales_2\lpcopen_lpc4337\inc
SET INC_PATH=.\inc
SET FILENAME=
...
arm-none-eabi-gcc %FILENAME% -Xlinker --start-group ../../lpcopen_lpc4337/Debug/liblpcopen_lpc4337.a -Xlinker --end-group -o ../bin/%NOMBRE%.axf -fno-builtin -mcpu=cortex-m4 -mfpu=fpv4-sp-d16 -mfloat-abi=softfp -mthumb -Wl,-Map="../bin/%NOMBRE%.map",-gc-sections -nostdlib -T "../ld/ciaa_lpc4337.ld" 
